...
export function AuthModal({ isOpen, onClose, onSuccess }) {
    ...
    const { login, loginAsync, isLoggingIn, loginError, register, registerAsync, isRegistering, registerError } = useAuth();
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const result = await loginAsync({ email: loginForm.email, password: loginForm.password });
            if (result.success) {
    ...
    const handleRegister = async (e) => {
        ...
        if (!registerForm.firstName || !registerForm.lastName || !registerForm.email || !registerForm.phoneNumber || !registerForm.password) {
                    ...
                    {activeTab === 'login' && (
                        <div id="login-tab" className="tab-content active">
                            ...
                            <form id="login-form" onSubmit={handleLogin}>
                                ...
                                {loginError && <p className="error-text">{loginError.message}</p>}
                    ...
                    {activeTab === 'register' && (
                        <div id="register-tab" className="tab-content active">
                            ...
                            <form id="register-form" onSubmit={handleRegister}>
                                ...
                                {registerError && <p className="error-text">{registerError.message}</p>}
