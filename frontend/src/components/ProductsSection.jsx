    ...
    const filteredProducts = useMemo(() => {
        return products.filter(product => {
            ...
            const matchesCategory = !selectedCategory ||
                (product.category && String(product.category.id) === String(selectedCategory));
                ...
                <div className="filters">
                    ...
                    >
                        ...
                        {categories.map((cat, index) => (
                            <option key={cat.id || `cat-${index}`} value={cat.id}>{cat.name || 'Unnamed Category'}</option>
                        ))}
                    </select>
                    <select 
                        id="brand-filter" 
                    ...
                    >
                        ...
                        {brands.map((brand, index) => (
                            <option key={brand.id || `brand-${index}`} value={brand.id}>{brand.name || 'Unnamed Brand'}</option>
                        ))}
                    </select>
                    <input 
                        type="text" 
